...
**WG Hope Bot** — Telegram-бот для выдачи WireGuard-доступов и веб-мониторинга пользователей/конфигов.

Проект ориентирован на практическое администрирование VPN-сервера: управление доступами, логирование и мониторинг в одном месте.
...
- `v1.1.1` — hotfix кодировки русского текста в фильтрах/формах мониторинга
